                    ...
                    <div class="card shadow border-0 p-5">
                        ...
                        <form action="{{ route('account.processResetPassword') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" value="" name="confirm_new_password" id="confirm_new_password" class="form-control @error('confirm_new_password') is-invalid @enderror" placeholder="New Password">
